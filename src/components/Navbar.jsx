...
const Navbar = () => {
    ...
    const toggleMobileMenu = () => {
        ...
        setMobileDropdownOpen(null); // Close any open mobile dropdowns
    };
    ...
    const openBookingForm = () => {
        window.open(GOOGLE_FORM_URL, '_blank');
        closeDropdown();
        closeMobileMenu(); // Close mobile menu when opening form
    };
    ...
    return (
        <div className={`text-lg w-full fixed top-0 z-50 ${isScrolled ? 'text-black' : 'text-white'}`}>
            ...
            <nav className={`h-[70px] flex items-center justify-between px-6 md:px-16 lg:px-24 xl:px-32 py-4 transition-all duration-300 shadow-sm bg-white text-black`}>
                ...
                {/* Mobile Menu Button - FIXED: Added onClick handler */}
                <button
                    aria-label="menu-btn"
                    type="button"
                ...
                {/* Mobile Nav - FIXED: Added state-based visibility and proper navigation */}
                <div className={`mobile-menu absolute top-[70px] left-0 w-full bg-white shadow-lg p-6 md:hidden transition-all duration-300 ${isMobileMenuOpen ? 'block' : 'hidden'}`}>
                    <ul className="flex flex-col space-y-4 text-lg">
                        {/* Who We Are Mobile Dropdown */}
                        <li>
                            <button
                                onClick={() => toggleMobileDropdown('whoWeAre')}
                                className="flex items-center justify-between w-full text-sm text-left text-gray-700 hover:text-orange-500 transition-colors"
                            >
                                <span>Who We Are</span>
                                <svg
                                    className={`w-4 h-4 transition-transform ${mobileDropdownOpen === 'whoWeAre' ? 'rotate-180' : ''}`}
                                    fill="none"
                                    stroke="currentColor"
                                    viewBox="0 0 24 24"
                                >
                            ...
                            {/* Mobile Dropdown Content for Who We Are */}
                            {mobileDropdownOpen === 'whoWeAre' && (
                                <div className="mt-3 ml-4 space-y-3 border-l-2 border-orange-200 pl-4">
                                    <button
                                        onClick={() => handleRedirect('/about')}
                                        className="block text-xs text-gray-600 hover:text-orange-500 transition-colors"
                                    >
                                        About Us
                                    </button>
                                    <button
                        ...
                        <li>
                            ...
                            >
                                <span>What We Do</span>
                                <svg
                                    className={`w-4 h-4 transition-transform ${mobileDropdownOpen === 'whatWeDo' ? 'rotate-180' : ''}`}
                                    fill="none"
                                    stroke="currentColor"
                                    viewBox="0 0 24 24"
                                >
                            ...
                            {/* Mobile Dropdown Content for What We Do */}
                            {mobileDropdownOpen === 'whatWeDo' && (
                                <div className="mt-3 ml-4 space-y-3 border-l-2 border-orange-200 pl-4">
                                    <button
                        ...
                        {/* Why ELoopDevSolutions Mobile Dropdown */}
                        <li>
                            <button
                                onClick={() => toggleMobileDropdown('whyMadBrains')}
                                className="flex items-center justify-between w-full text-sm text-left text-gray-700 hover:text-orange-500 transition-colors"
                            >
                                <span>Why ELoopDevSolutions</span>
                                <svg
                                    className={`w-4 h-4 transition-transform ${mobileDropdownOpen === 'whyMadBrains' ? 'rotate-180' : ''}`}
                                    fill="none"
                                    stroke="currentColor"
                                    viewBox="0 0 24 24"
                                >
                            ...
                            {/* Mobile Dropdown Content for Why ELoopDevSolutions */}
                            {mobileDropdownOpen === 'whyMadBrains' && (
                                <div className="mt-3 ml-4 space-y-3 border-l-2 border-orange-200 pl-4">
                                    <button
                        ...
                        <li>
                            <button
                                onClick={() => handleRedirect('/Blog')}
                                className="text-sm text-left text-gray-700 hover:text-orange-500 transition-colors w-full text-left"
                            >
                                Blog
                            </button>
                        </li>
                    ...
                    <button
                        ...
                        type="button"
                        className="bg-orange-500 text-white border border-orange-500 mt-6 text-sm hover:bg-orange-600 active:scale-95 transition-all w-full h-11 rounded-full"
                    >
                        Book A Call
                    </button>
                </div>
