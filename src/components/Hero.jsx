...
const FloatingIcon = ({ icon, className, delay = 0 }) => {
  ...
  return (
    ...
    >
      <div 
        className={`w-6 h-6 transition-all duration-300 ${isHovered ? 'text-teal-400' : 'text-white'} flex items-center justify-center font-bold text-lg`}
      >
        {icon}
      </div>
    </div>
...
const Hero = () => {
  ...
  return (
    <div className="relative min-h-screen bg-gradient-to-br bg-black overflow-hidden pt-15">
      ...
      <FloatingIcon 
        icon="✨" 
        className="bottom-1/2 right-1/4 bg-teal-600/20 border border-teal-500/30" 
        delay={2.5}
      />
      <FloatingIcon 
        icon="🚀" 
      ...
      <div className="relative z-10 flex flex-col items-center justify-center min-h-screen px-4 text-center">
        ...
        <h1 className="text-2xl md:text-4xl lg:text-7xl font-bold text-white mb-8 max-w-6xl">
          <span className="bg-gradient-to-r from-white via-gray-100 to-teal-300 bg-clip-text text-transparent">
            Designing & Developing Your
          </span>
          <br />
          <span className="bg-gradient-to-r from-teal-100 via-teal-200 to-teal-300 bg-clip-text text-transparent">
            Vision For Growth
          </span>
        </h1>
        ...
        <button 
          ...
          className="mt-8 bg-gradient-to-r from-teal-500 to-teal-600 hover:from-teal-600 hover:to-teal-700 text-white font-semibold px-8 py-4 rounded-full transition-all duration-300 transform hover:scale-105 shadow-2xl flex items-center gap-3 group"
        >
